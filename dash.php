      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=4">Agregar módulo</a></li>
            <li><a href="dash.php?q=5">Eliminar módulo</a></li>
...
<tr><td><b>S.N.</b></td><td><b>Módulos</b></td><td><b>Total de Preguntas</b></td><td><b>Intentos</b></td><td><b>Tiempo Límite</b></td><td></td></tr>';
$c=1;
...
if($rowcount == 0){
	...
	<td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Vista</b></span></a></b></td></tr>';
}
else
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="Módulo ya resuelto" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Reintentar</b></span></a></b></td></tr>';
}
}
$c=0;
echo '</table></div></div>';
...
<tr style="color:red"><td><b>Posición</b></td><td><b>Nombre</b></td><td><b>Ficha</b></td><td><b>Centro</b></td><td><b>Calificación</b></td></tr>';
$c=0;
...
$result = mysqli_query($con,"SELECT * FROM user order by college, name") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Nombre</b></td><td><b>Ficha</b></td><td><b>Centro</b></td><td><b>Correo Electrónico</b></td><td><b>Documento</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Detalles del módulo</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Ingrese el título del Módulo" class="form-control input-md" type="text" required>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Ingrese el número de puntos por respuesta correcta" class="form-control input-md" min="1" type="number" required>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Ingrese el número de puntos a restar en la respuesta incorrecta sin signo" class="form-control input-md" min="0" type="number" required>
...
while($row = mysqli_fetch_array($result)) {
  ...
  $time = $row['time'];
	$eid = $row['eid'];
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><a href="update.php?q=rmquiz&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Borrar</b></span></a></b></td></tr>';
}
$c=0;
echo '</table></div></div>';
