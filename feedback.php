...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="email" name="email" placeholder="Ingrese correo electrónico" class="form-control input-md" type="email">
...
<div class="form-group">
  ...
  <div class="col-md-6">
    <input id="password" name="password" placeholder="Ingrese contraseña" class="form-control input-md" type="password">
...
<p>Para comunicarse con nosotros sencillamente puede diligenciar el siguiente formulario.</p>
...
<!-- Text input-->
<div class="form-group">
  <input id="name" name="name" placeholder="Ingrese su nombre" class="form-control input-md" type="text" required><br />    
   <input id="name" name="subject" placeholder="Escriba el asunto" class="form-control input-md" type="text" required>    
...
<!-- Text input-->
<div class="form-group">
  <input id="email" name="email" placeholder="Ingrese su correo electrónico" class="form-control input-md" type="email" required>    
 </div>
</div>
</div><!--End of row-->
