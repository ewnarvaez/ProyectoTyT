...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Pre TyT.</b></a>
    </div>
...
if($rowcount == 0){
	...
	<td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Prueba</b></span></a></b></td></tr>';
}
else
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi.'</td><td>'.$time.'&nbsp;min</td>
...
?>
<div align="right">
  <span id="countdown" class="timer">Tiempo: 0:00</span>
</div>
<script>
var seconds = 100;
    ...
    document.getElementById('countdown').innerHTML = "Tiempo: "+minutes + ":" +    remainingSeconds;
    if (seconds == 0) {
...
<tr style="color:red"><td><b>S.N.</b></td><td><b>Módulo</b></td><td><b>Preguntas Resueltas</b></td><td><b>Buenas</b></td><td><b>Equivocadas<b></td><td><b>Puntaje</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>Nombre</b></td><td><b>Centro</b></td><td><b>Puntaje</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
